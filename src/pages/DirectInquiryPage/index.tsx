...
import { Dimensions, Pressable, StyleSheet, TextInput, TouchableWithoutFeedback, View } from 'react-native';
...
const inquiryTypeList: DropdownItem[] = [
...
const DirectInquiryPage = ({}: DirectInquiryPageProps) => {
  ...
  const onChangeType = (item: DropdownItem) => {
    setInquiryType(item);
